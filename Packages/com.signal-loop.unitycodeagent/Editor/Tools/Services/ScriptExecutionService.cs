...
namespace SignalLoop.UnityCodeAgent.Tools.Services
{
    /// <summary>
    ...
    public class ScriptExecutionService
    {
        ...
        public ScriptExecutionService(UnityContext context)
        {
        ...
        public async Task<ExecutionResult> ExecuteScriptAsync(string script)
        {
            ...
            catch (CompilationErrorException compilationError)
            {
                ...
                _log.Error(nameof(ScriptExecutionService), $"Script execution compilation error:\n{errorDetails}");
            ...
            catch (Exception ex)
            {
                ...
                _log.Error(nameof(ScriptExecutionService), $"Script execution runtime error:\n{errorDetails}");
        ...
        {
            IReadOnlyList<string> assemblyNames = _context.ToolAssemblyNames;
        ...
        private MetadataReference[] CreateInMemoryReferences(System.Reflection.Assembly[] assemblies)
        {
            ...
            foreach (Assembly assembly in assemblies)
            {
                ...
                {
                    _log.Warning(nameof(ScriptExecutionService), $"Failed to load metadata for assembly '{assembly.GetName().Name}' at '{location}': {ex.Message}");
                }
            }
