...
{
    public static class InputActionAssetResolver
    {
        public static InputActionAsset LoadInputActionAsset(UnityContext context, out string warningMessage)
        {
            string configuredPath = context?.InputActionsAssetPath ?? string.Empty;
