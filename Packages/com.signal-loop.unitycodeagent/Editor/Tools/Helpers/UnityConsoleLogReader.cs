...
namespace SignalLoop.UnityCodeAgent.Tools.Helpers
{
    ...
    public static class UnityConsoleLogReader
    {
        ...
        public static UnityConsoleLogReadResult ReadTail(int maxEntries)
        {
            ...
            {
                _log.Error(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: error reading logs: {ex.Message}");
        ...
        private static int SafeGetMode(FieldInfo modeField, object logEntry)
        {
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: could not read mode: {ex.Message}");
                return 0;
            }
        }
        ...
        private static bool TryGetEntryText(MethodInfo getLinesAndModeFromEntryInternal, int row, int numberOfLines, out string text, out int mode)
        {
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: could not read formatted entry text for row {row}: {ex.Message}");
                return false;
            }
        }
        ...
        private static int SafeGetEntryCount(MethodInfo getEntryCount, int row)
        {
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: could not read entry count for row {row}: {ex.Message}");
                return 0;
            }
        }
        ...
        private static LogMessageFlagsAccessor CreateLogMessageFlagsAccessor()
        {
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), "UnityConsoleLogReader: could not resolve UnityEditor.LogMessageFlags reflection types.");
                return null;
            }
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), "UnityConsoleLogReader: could not resolve UnityEditor.LogMessageFlagsExtensions methods.");
                return null;
            }
        ...
        private static bool InvokeFlagPredicate(MethodInfo method, object flags, string methodName)
        {
            ...
            {
                _log.Debug(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: could not invoke {methodName} on LogMessageFlagsExtensions: {ex.Message}");
                return false;
            }
        }
        ...
        private static void SafeInvokeMethod(MethodInfo method, string methodName)
        {
            ...
            {
                _log.Error(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: error invoking {methodName}: {ex.Message}");
            }
        }
        ...
        private static int SafeGetLogCount(MethodInfo getCount)
        {
            ...
            {
                _log.Error(nameof(UnityConsoleLogReader), $"UnityConsoleLogReader: error getting log count: {ex.Message}");
                return 0;
            }
        }
